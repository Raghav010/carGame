...
let lapped=0;
// lane-width=1.5
const oppCars=[{name:"cybertruck",stage:0,speed:0.03,driftDir:xaxis,midpointArr:[[-16.75,9.75],[-22.75,20.75]],fuel:110,health:80,laps:0},
                {name:"f1car",stage:0,speed:0.035,driftDir:xaxis,midpointArr:[[-18.25,11.25],[-24.25,22.25]],fuel:140,health:70,laps:0},
                {name:"musclecar",stage:0,speed:0.04,driftDir:xaxis,midpointArr:[[-21.25,14.25],[-27.25,25.25]],fuel:160,health:100,laps:0}]
...
async function main()
{
    ...
    scoreHUD.innerText="Score: "+(health+2*laps+2*fuel);
    ...
    function updateStats()
    {
        ...
        lapHUD.innerText="Laps: "+laps;
        scoreHUD.innerText="Score: "+Math.trunc(health+2*laps+2*fuel);
